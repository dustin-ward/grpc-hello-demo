...
inline const ::std::string& Message::body() const {
  // @@protoc_insertion_point(field_get:chat.Message.body)
  return body_.GetNoArena();
}
inline void Message::set_body(const ::std::string& value) {
  
  body_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(), value);
  // @@protoc_insertion_point(field_set:chat.Message.body)
}
#if LANG_CXX11
inline void Message::set_body(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:chat.Message.body)
}
#endif
inline void Message::set_body(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:chat.Message.body)
}
inline void Message::set_body(const char* value, size_t size) {
  
  body_.SetNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:chat.Message.body)
}
inline ::std::string* Message::mutable_body() {
  
  // @@protoc_insertion_point(field_mutable:chat.Message.body)
  return body_.MutableNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
inline ::std::string* Message::release_body() {
  // @@protoc_insertion_point(field_release:chat.Message.body)
...
inline void Message::set_allocated_body(::std::string* body) {
  ...
  // @@protoc_insertion_point(field_set_allocated:chat.Message.body)
}
